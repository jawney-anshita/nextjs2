...
import ProductVisibility from '../Sell/PropertyVisibility';
...
export default function PropertySell(props) {
    ...
    return (
        <Box sx={{ flexGrow: 1 }}>
            ...
            Check the box if want to make property live: <ProductVisibility onChangeVisibility={onChangeVisibility}></ProductVisibility>
          </Typography>
            </Grid>)}
