...
export default function RoomDetails(props) {
  ...
  const defaultbedrooms = props.bedrooms;
  const defaultwashrooms = props.washrooms;
  const defaultbalconies = props.balconies;
